...
function wyliczSztukiPlynu(){
 let towar_1ML=parseFloat(document.getElementsByClassName("plynTowar_1_Ml")[0].value.replace(/\,/g, ".")
)
  let towar_1Szt=parseFloat(document.getElementsByClassName("plynTowar_1_Szt")[0].value.replace(/\,/g, ".")
)
 let  towar_2Ml=parseFloat(document.getElementsByClassName("plynTowar_2_Ml")[0].value.replace(/\,/g, ".")
)
...
function wyliczSztukiBlach(){
    let towar_1_dl=parseFloat(document.getElementById("blachaTowar_1_Dl").value.replace(/\,/g, ".")
)
